...

{
    ...
    public function tesekkurler(){
        ...
        return view('contact.tesekkurler');
    ...
    public function contactSend(Request $request){
...

       {
           ...
           $message->from('info@boss4.com.tr', "Alya Projeleri Talep Formu");

           $message->subject("Alya Projeleri Talep Formu");

           $message->to('turanguler@boss4.com.tr');
    ...
    return redirect('tesekkurler')->with('status', 'Mesajınız Gönderildi! En Kısa Sürede Tarafınıza Dönüş Sağlanacaktır.');
